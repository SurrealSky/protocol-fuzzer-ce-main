            ...
            if (entry.Library.versions[0].version === 1) {
                ...
                this.$modal.open({
                    ...
                    resolve: {
                        ...
                        Prompt: function () {
                            return "This will create a new configuration for the <code>".concat(entry.Pit.name, "</code> pit. ") +
        ...
        LibraryController.prototype.DoNewConfig = function (modal) {
            this.pitService.NewConfig(modal.Pit)
                ...
                switch (response.status) {
                    case 400:
                        modal.SetError("".concat(modal.Pit.name, " already exists, please choose a new name."));
                        break;
                    default:
                        modal.SetError("Error: ".concat(response.statusText));
                        break;
                }
            });
        };
        LibraryController.prototype.OnCopyPit = function (entry) {
            ...
            this.$modal.open({
                ...
                resolve: {
                    ...
                    Prompt: function () { return "This will create a copy from the <code>".concat(entry.Pit.name, "</code> pit configuration. "); },
                    Pit: function () { return angular.copy(entry.Pit); },
                    OnSubmit: function () { return function (modal) { return _this.DoNewConfig(modal); }; }
                }
    ...
    var MigratePitController = (function () {
        ...
        MigratePitController.prototype.MigratePit = function (originalPit) {
            ...
            this.pitService.MigratePit(this.Pit, originalPit)
                ...
                switch (response.status) {
                    case 400:
                        _this.Error = "".concat(_this.Pit.name, " already exists.");
                        break;
                    default:
                        _this.Error = "Error: ".concat(response.statusText);
                        break;
                }
            });
        };
...
(function (Peach) {
    ...
    function flatten(nodes, depth, prefix, parent, result) {
        nodes.forEach(function (node) {
            var here = "".concat(prefix).concat(node.id);
            var flat = {
                node: node,
                parent: parent,
                id: node.id,
            ...
            result.total++;
            flatten(node.fields, depth + 1, "".concat(flat.fullId, "."), flat, result);
        });
    }
    ...
    function extractWeights(prefix, tree, collect) {
        for (var _i = 0, tree_1 = tree; _i < tree_1.length; _i++) {
            ...
            extractWeights("".concat(here, "."), node.fields, collect);
        }
    }
    ...
    var ConfigureTuningController = (function () {
        ...
        ConfigureTuningController.prototype.search = function (search) {
            ...
            var partial = new RegExp("(".concat(lastPart, ")"), 'gi');
            var starting = new RegExp("^(".concat(lastPart, ")"), 'i');
            this.source.forEach(function (node) {
                ...
                if (_.isEmpty(parts)) {
                    ...
                    if (_.startsWith(id, lastPart)) {
                        ...
                        for (var _a = 0, parts_2 = parts; _a < parts_2.length; _a++) {
                            var part = parts_2[_a];
                            cur.display = "<strong>".concat(cur.id, "</strong>");
                            cur = cur.parent;
                        }
                    }
                }
    ...
    var AgentController = (function () {
        ...
        Object.defineProperty(AgentController.prototype, "Header", {
            get: function () {
                ...
                var name = this.$scope.agent.name ? "(".concat(this.$scope.agent.name, ")") : '';
                return "".concat(url, " ").concat(name);
            },
            enumerable: false,
            configurable: true
        });
...
(function (Peach) {
    ...
    var FaultFilesController = (function () {
        ...
        FaultFilesController.prototype.Name = function (i, file) {
            ...
            return "#".concat(i + 1, " - ").concat(dir, " - ").concat(file.name);
        };
        ...
        FaultsDirectiveController.prototype.RefreshFaults = function () {
            ...
            if (this.bucket === 'all') {
                ...
                faults = _.filter(this.jobService.Faults, function (fault) {
                    return _this.bucket === ("".concat(fault.majorHash, "_").concat(fault.minorHash));
                });
            }
            if (this.$scope.limit) {
    ...
    var MonitorController = (function () {
        ...
        Object.defineProperty(MonitorController.prototype, "Header", {
            get: function () {
                ...
                var name = this.$scope.monitor.name ? "(".concat(this.$scope.monitor.name, ")") : '';
                return "".concat(monitor, " ").concat(name);
            },
            enumerable: false,
            configurable: true
        });
...
(function (Peach) {
    Peach.SmartTableRatioDirective = {
        ...
        link: function (scope, element) {
            element.css('width', "".concat(scope.stRatio, "%"));
        }
    };
})(Peach || (Peach = {}));
var Peach;
...
(function (Peach) {
    Peach.UniqueDirective = {
        ...
        scope: {
            unique: "&".concat(Peach.C.Directives.Unique),
    ...
    Peach.UniqueChannelDirective = {
        ...
        controllerAs: 'ctrl',
        scope: {
            channel: "@".concat(Peach.C.Directives.UniqueChannel),
            defaultValue: '@peachUniqueDefault',
    ...
    var EulaService = (function () {
        ...
        EulaService.prototype.DisplayEula = function (type) {
            return this.$modal.open({
                templateUrl: "html/eula/".concat(type, ".html"),
